...
// Add CSS to limit the width of the featured image path column
add_action('admin_head', 'add_style_col_featured');
function add_style_col_featured()
{
    echo '<style type="text/css">';
    echo '.column-featured_image_path { max-width: 250px; overflow: hidden; text-overflow: ellipsis; }';
    echo '</style>';
}
